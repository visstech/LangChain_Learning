'''
Step 13 — Human Correction / Editing
Now we're going to learn another very important HITL pattern:
The AI proposes something → Human reviews it → Human can correct it 
→ workflow continues using the corrected value.
